...
\part[5] Now change the tournament to make each series as a \emph{best-of-$k$} series. How large should $k$ be, and so how many games do you end up conducting in total to get a $1-\epsilon$ probability of the best team winning the overall series?
  \begin{solution}
  \begin{proof}
  $1 + 1 = 2$.
  \end{proof}
